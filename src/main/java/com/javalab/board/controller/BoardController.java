 ...
 * - JSP의 요청을 받아서 요펑 사항을 처리하고 처리 결과를 model에 저장한다.
...
public class BoardController {
	...
	/*
	 * 의존성주입(DI - Dependency Injection 방법)
	 ...
	 *  - 인터페이스의 메소드를 호출하면 실질적으로는 Impl 객체의 메소드가
	 *    대신 호출된다.
	 */
	
	// BoardDao -> BoardServiceImpl로 변경
	@Autowired
	 ...
	 *    있는지 정보를 모두 취합해서 Map 형태로 갖고있다. url(key - 메소드명(value) 
	 */
