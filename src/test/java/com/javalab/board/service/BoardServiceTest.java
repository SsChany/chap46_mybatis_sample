 ...
 *  assertNotNull(검증 기재) : 괄호 안에 있는 객체가 널이 아닐 것이라고 가정(assert)
...
public class BoardServiceTest {
	...
	/*
	 * 핵심 빈(Bean)인 BoardDao 가 정상적으로 의존성 주입되는지 확인
	 */
	@Test @Ignore
	...
	public void testSelectBoardList() {
		...
		// 위와 assertNotNull까지만 체크해도 되지만 실제 결과를 보고싶을때 아래와 같이 테스트 해볼 수 있다.
